...
class MapOverview
  def initialize(left, top, parent_window, size = UiConstants::MINI_TILE_SIZE)
    ...
    @red_arrow_up = Gosu::Image.new(parent_window,
                                    'media/red_arrow_up.png', true)

    @red_arrow_left = Gosu::Image.new(parent_window,
                                      'media/red_arrow_left.png', true)

    @red_arrow_right = Gosu::Image.new(parent_window,
                                       'media/red_arrow_right.png', true)

    @red_arrow_down = Gosu::Image.new(parent_window,
                                      'media/red_arrow_down.png', true)
  end
